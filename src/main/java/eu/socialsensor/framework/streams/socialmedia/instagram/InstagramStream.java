package eu.socialsensor.framework.streams.socialmedia.instagram;
...
public class InstagramStream extends Stream {
	...
	public void open(StreamConfiguration config) throws StreamException {
		...
		retriever = new InstagramRetriever(secret, token,Integer.parseInt(maxResults),Integer.parseInt(maxRequests),this);
