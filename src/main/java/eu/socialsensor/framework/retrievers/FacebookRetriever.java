...
import eu.socialsensor.framework.abstractions.FacebookItem;
import eu.socialsensor.framework.abstractions.FacebookStreamUser;
...
public class FacebookRetriever implements Retriever {
	...
	public List<Item> retrieveUserFeeds(SourceFeed feed){
		...
		logger.info("#Facebook : Handler fetched " + items.size() + " posts from " + userFeed + 
