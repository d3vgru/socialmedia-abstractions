 ...
 */
public class FlickrRetrieverNew implements Retriever {

	private Logger logger = Logger.getLogger(FlickrRetrieverNew.class);
	...
	public FlickrRetrieverNew(String flickrKey, String flickrSecret,Integer maxResults,Integer maxRequests) {
